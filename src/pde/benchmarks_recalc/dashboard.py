...
Mirrors the style of pde.reporting.dashboard (inline CSS, light+dark, no external deps) but keeps its
...
from pde.reporting.dashboard_kit import esc as _esc, fmt_num, fmt_pct, chip, tile as _tile, page as _kit_page
from pde.utils.metric_format import format_value as _format_value
