...
Dampening (src/pde/prioritization/dampening.py) halves the priority_score of a candidate topic
...
from pde.ingestion.coaching_history import map_coaching_events
