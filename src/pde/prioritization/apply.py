# src/pde/prioritization/apply.py
...
from pde.prioritization.weights import get_metric_weight, get_topic_weight, _unwrap_root
from pde.prioritization.eligibility import apply_eligibility
from pde.utils.frames import require_cols as _require_cols
