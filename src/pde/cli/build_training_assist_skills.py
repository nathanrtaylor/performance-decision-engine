...
skill-level tall-skinny CSV that build_signals consumes.
    ...
    python -m pde.cli.build_training_assist_skills
...
from pde.ingestion.training_assist_skills import build_training_assist_skills
from pde.utils.io import load_yaml, read_parquet_or_csv
