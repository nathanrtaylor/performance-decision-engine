...
CLI: discover candidate coaching themes from population co-movement (propose-only by default).
    ...
    python -m pde.cli.discover_themes --configs-dir configs \
...
from pde.themes_discovery.compare import compare
from pde.themes_discovery.config import DiscoveryThresholds, HOLD, PROPOSE, SKIPPED
from pde.themes_discovery.dashboard import write_discovery_dashboard
from pde.themes_discovery.emit import write_diff_json, write_proposed_yaml, write_summary_txt
from pde.themes_discovery.prep import build_bad_axis_by_cohort, load_latest_extract, prep_frames
from pde.themes_discovery.recompute import cluster_into_themes, compute_comovement
