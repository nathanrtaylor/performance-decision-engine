...
CLI: the one-command weekly operator entry point.
    ...
    python -m pde.cli.run_weekly [--raw-dir ...] [--strict-preflight]
    python -m pde.cli.run_weekly --apply-benchmarks --approver "name"   # authorized
...
from pde.cli import recalc_benchmarks, run_pipeline
