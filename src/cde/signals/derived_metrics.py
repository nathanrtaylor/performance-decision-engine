# src/cde/signals/derived_metrics.py
"""
...
whose per-row metric label lives in ``metric_key_col``:
  * the main pipeline (src/cde/cli/run_pipeline.py), between normalize_inputs and build_signals
  * benchmark recalculation (src/cde/benchmarks_recalc/prep.py)
"""
